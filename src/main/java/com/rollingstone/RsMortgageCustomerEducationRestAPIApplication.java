...
@EnableFeignClients
public class RsMortgageCustomerEducationRestAPIApplication extends SpringBootServletInitializer {

    private static final Class<RsMortgageCustomerEducationRestAPIApplication> applicationClass = RsMortgageCustomerEducationRestAPIApplication.class;
